...
真实 LLM Provider、Agent API、Embedding、Qdrant、RAG、Agent Loop、前端和 checkpoint 尚未完成，不计入当前功能。
...
最终 v2 规划使用但尚未完成：Qdrant、OpenAI-compatible Chat/Embedding Provider、React + Vite。
...
1. 实现受约束 LLM Agent：结构化 Planner、工具白名单、Observation、有限 replan 和简单 DAG。
